...
const TaskList = () => {
  ...
  return (
    <div className="task-list w-full ">
      <h2 className="text-4xl font-bold my-10 text-center text-indigo-500">Available Tasks</h2>
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        {tasks.map((task) => (
          <div key={task._id} className="task-card bg-white p-4 rounded-lg shadow-lg">
            <img className='w-full' src={task.task_image_url} alt="" />
            ...
            <p className="text-gray-600 mt-1"><strong>Payable Amount:</strong> ${task.payable_amount}</p>
