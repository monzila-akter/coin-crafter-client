...
const Features = () => {
  const features = [
    ...
    },
    {
      ...
      icon: <FaHeadset className="text-indigo-500 text-5xl" />,
    },
  ];
    ...
    <section className="mb-10 md:mb-24 px-5 md:px-10 lg:px-14 container mx-auto">
      <div className="container mx-auto text-center">
        ...
        <motion.h2
          ...
          className="text-4xl font-bold text-indigo-500 mb-5"
        >
          Features & Benefits
        </motion.h2>
        <motion.p
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {features.map((feature, index) => (
            <motion.div
              ...
              className="p-8 rounded-lg shadow-md bg-indigo-50 flex flex-col items-center text-center"
            >
